...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-masked-field', __webpack_require__(3));
    Vue.component('detail-masked-field', __webpack_require__(6));
    Vue.component('form-masked-field', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("span", [_vm._v(_vm._s(_vm.maskedText))])
}
var staticRenderFns = []
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        this.field.value = this.text.replace(/./g, '*');
    }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        maskedClick: function maskedClick() {
            if (!this.viewField) {
                this.viewField = true;
      ...
      _c("template", { slot: "field" }, [
        _c("div", { staticClass: "flex items-center" }, [
          ...
          _c(
            ...
            {
              staticClass:
                "btn btn-default btn-primary inline-flex items-center relative ml-3",
              staticStyle: { cursor: "grab" },
              on: { click: _vm.maskedClick }
            },
            [_vm._v(_vm._s(_vm.viewButtonText))]
          )
        ])
      ])
    ],
